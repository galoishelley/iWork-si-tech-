...
#define KIMASTERKEY "1234567890123456"
...
int des_enc_write(int fd,char *buf,int len,des_key_schedule sched,\
	des_cblock *iv);
char *docrypt(char *buf,char *salt);
...
void spublicKiCrypt(const char *src, char *dest, char *key, int flags);
#endif
#endif
